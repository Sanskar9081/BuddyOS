...
class HudCanvas(QWidget):
    ...
    def paintEvent(self, _):
        ...
        # removed legacy sci-fi UI elements
...
class RemoteKeyOverlay(QWidget):
    ...
    def mark_connected(self) -> None:
        ...
        self._timer_lbl.setText("Phone connected — BUDDY ready")
...
class MainWindow(QMainWindow):
    ...
    def _build_header(self) -> QWidget:
        ...
        lay.addWidget(_badge("BUDDY", C.PRI_DIM))
        lay.addStretch()
    ...
    def _build_content_panel(self) -> QWidget:
        """
        Collapsible panel below the HUD — shows search results, briefings.
        ...
        dismiss.setStyleSheet(f"""
            QPushButton {{
                ...
                border: 1px solid {C.BORDER}; border-radius: 8px; padding: 0 5px;
            }}
    ...
    def _build_footer(self) -> QWidget:
        ...
        lay.addStretch()
        lay.addWidget(_fl("Think · Execute · Deliver"))
        lay.addStretch()
        lay.addWidget(_fl("© BUDDYOS ", C.PRI_DIM))
        return w
